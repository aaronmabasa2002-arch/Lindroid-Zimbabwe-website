    ...
    <section id="about" className="about-section">
      <div className="container">
        ...
        <p className="about-intro">
          Education is the most powerful investment in a child's future. At Lindroid
          Zimbabwe, we combine strong academic foundations with practical, modern
          learning methods so every student can think critically, solve real problems,
